...
//Jaba first section ko bottom purai scroll then only open the base
...
const SecondSection = () => {
    ...
    const transformYScale = useTransform(scrollYProgress, [0, 1], ["-20vh", "479vh"]);
    const rotateZScale = useTransform(scrollYProgress, [0, 0.05], [0, -85]);

    return (
        <section ref={container} className="secondContainer">
            <div>
            ...
            <div>
                <motion.div style={{ rotateZ: rotateZScale }} className="doorBase"></motion.div>
